...
# Durch die einmalige fallende Flanken von Min-Button soll die Minuten auf 1 Minute und 1 Sekunde Start-Zeit eingestellt werden
# Anschließend mit einer fallenden Flanke von Start-Stop-Button die Zeitmessung gestartet
# Mit START_STOP_BUTTON wurde dann wiederum die Zeit angehalten.
# Die Zeit wird kurz dargestellt bis sie von Min- und Sek-Button wieder verändert wird

force clk 1 0, 0 {50 ps} -r {100 ps}
force MIN_BUTTON 1 0, 0 {50 ps} -r {5000 ps}
force SEK_BUTTON 1 0, 0 {50 ps} -r {5300 ps}
force START_STOP_BUTTON 1 0, 0 {50 ps} -r {6700 ps}
