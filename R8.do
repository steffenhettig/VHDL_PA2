...
# Die Zeit für die Tonausgabe läuft ab und die ursprüngliche Zeit wird wieder angezeigt

force clk 1 0, 0 {50 ps} -r {100 ps}
force SEK_BUTTON 1 0, 0 {50 ps} -r {10000 ps}
force START_STOP_BUTTON 1 0, 0 {50 ps} -r {19000 ps}
